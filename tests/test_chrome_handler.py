"""Tests for Chrome browser handler."""
...
class TestChromeHandler:
    """Test Chrome browser handler functionality."""
    
    @pytest.fixture
    def handler(self):
        """Create Chrome handler instance."""
        return ChromeBrowserHandler()
    ...
    def test_get_profile_data(self, handler, test_profiles: Dict[str, Dict[str, Path]], test_data: Dict[str, Any]):
        """Test extracting Chrome profile data.
        
        Args:
            handler: Chrome handler instance
            test_profiles: Test profile directories
            test_data: Test data for validation
        """
        profile_dir = test_profiles["chrome"]["Default"]
    ...
    def test_migrate_profile(self, handler, test_profiles: Dict[str, Dict[str, Path]], temp_dir: Path):
        ...
        """
        source_dir = test_profiles["chrome"]["Default"]
        target_dir = temp_dir / "migrated_chrome"
    ...
    def test_edge_cases(self, handler, temp_dir: Path):
        """Test Chrome handler edge cases.
