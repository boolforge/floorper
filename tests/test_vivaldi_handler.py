"""Tests for Vivaldi browser handler."""
...
class TestVivaldiHandler:
    """Test Vivaldi browser handler functionality."""
    
    @pytest.fixture
    def handler(self):
        """Create Vivaldi handler instance."""
        return VivaldiBrowserHandler()
    ...
    def test_get_profile_data(self, handler, test_profiles: Dict[str, Dict[str, Path]], test_data: Dict[str, Any]):
        """Test extracting Vivaldi profile data.
        
        Args:
            handler: Vivaldi handler instance
            test_profiles: Test profile directories
            test_data: Test data for validation
        """
        profile_dir = test_profiles["vivaldi"]["Default"]
    ...
    def test_migrate_profile(self, handler, test_profiles: Dict[str, Dict[str, Path]], temp_dir: Path):
        """Test migrating Vivaldi profile.
        ...
        """
        source_dir = test_profiles["vivaldi"]["Default"]
        target_dir = temp_dir / "migrated_vivaldi"
    ...
    def test_edge_cases(self, handler, temp_dir: Path):
        """Test Vivaldi handler edge cases.
