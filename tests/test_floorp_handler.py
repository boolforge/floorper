"""Tests for Floorp browser handler."""
...
class TestFloorpHandler:
    """Test Floorp browser handler functionality."""
    
    @pytest.fixture
    def handler(self):
        """Create Floorp handler instance."""
        return FloorpBrowserHandler()
        
    def test_detect_browser(self, handler):
        """Test Floorp browser detection."""
        assert handler.detect_browser() is True
        
    def test_get_profiles(self, handler):
        """Test getting Floorp profiles."""
    ...
    def test_get_profile_data(self, handler, test_profiles: Dict[str, Dict[str, Path]], test_data: Dict[str, Any]):
        """Test extracting Floorp profile data.
        
        Args:
            handler: Floorp handler instance
            test_profiles: Test profile directories
            test_data: Test data for validation
        """
        profile_dir = test_profiles["floorp"]["Default"]
    ...
    def test_migrate_profile(self, handler, test_profiles: Dict[str, Dict[str, Path]], temp_dir: Path):
        ...
        """
        source_dir = test_profiles["floorp"]["Default"]
        target_dir = temp_dir / "migrated_floorp"
    ...
    def test_edge_cases(self, handler, temp_dir: Path):
        """Test Floorp handler edge cases.
