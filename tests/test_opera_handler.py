"""Tests for Opera browser handler."""
...
class TestOperaHandler:
    """Test Opera browser handler functionality."""
    
    @pytest.fixture
    def handler(self):
        """Create Opera handler instance."""
        return OperaBrowserHandler()
    ...
    def test_get_profile_data(self, handler, test_profiles: Dict[str, Dict[str, Path]], test_data: Dict[str, Any]):
        """Test extracting Opera profile data.
        
        Args:
            handler: Opera handler instance
            test_profiles: Test profile directories
            test_data: Test data for validation
        """
        profile_dir = test_profiles["opera"]["Default"]
    ...
    def test_migrate_profile(self, handler, test_profiles: Dict[str, Dict[str, Path]], temp_dir: Path):
        ...
        """
        source_dir = test_profiles["opera"]["Default"]
        target_dir = temp_dir / "migrated_opera"
