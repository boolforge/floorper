"""Tests for exotic browser handler."""
...
class TestExoticHandler:
    """Test exotic browser handler functionality."""
    
    @pytest.fixture
    def handler(self):
        """Create exotic handler instance."""
        return ExoticBrowserHandler()
        
    def test_detect_browser(self, handler):
        """Test exotic browser detection."""
        assert handler.detect_browser() is True
        
    def test_get_profiles(self, handler):
        """Test getting exotic browser profiles."""
    ...
    def test_get_profile_data(self, handler, test_profiles: Dict[str, Dict[str, Path]], test_data: Dict[str, Any]):
        """Test extracting exotic browser profile data.
        
        Args:
            handler: Exotic handler instance
            test_profiles: Test profile directories
            test_data: Test data for validation
        """
        profile_dir = test_profiles["qutebrowser"]["Default"]
    ...
    def test_migrate_profile(self, handler, test_profiles: Dict[str, Dict[str, Path]], temp_dir: Path):
        """Test migrating exotic browser profile.
        ...
        """
        source_dir = test_profiles["qutebrowser"]["Default"]
        target_dir = temp_dir / "migrated_qutebrowser"
    ...
    def test_edge_cases(self, handler, temp_dir: Path):
        """Test exotic handler edge cases.
