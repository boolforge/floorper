"""Tests for Edge browser handler."""
...
class TestEdgeHandler:
    """Test Edge browser handler functionality."""
    
    @pytest.fixture
    def handler(self):
        """Create Edge handler instance."""
        return EdgeBrowserHandler()
    ...
    def test_get_profile_data(self, handler, test_profiles: Dict[str, Dict[str, Path]], test_data: Dict[str, Any]):
        """Test extracting Edge profile data.
        ...
        """
        profile_dir = test_profiles["edge"]["Default"]
    ...
    def test_migrate_profile(self, handler, test_profiles: Dict[str, Dict[str, Path]], temp_dir: Path):
        ...
        """
        source_dir = test_profiles["edge"]["Default"]
        target_dir = temp_dir / "migrated_edge"
