"""Tests for Brave browser handler."""
...
class TestBraveHandler:
    """Test Brave browser handler functionality."""
    
    @pytest.fixture
    def handler(self):
        """Create Brave handler instance."""
        return BraveBrowserHandler()
        
    def test_detect_browser(self, handler):
        """Test Brave browser detection."""
        assert handler.detect_browser() is True
        
    def test_get_profiles(self, handler):
        """Test getting Brave profiles."""
    ...
    def test_get_profile_data(self, handler, test_profiles: Dict[str, Dict[str, Path]], test_data: Dict[str, Any]):
        """Test extracting Brave profile data.
        
        Args:
            handler: Brave handler instance
            test_profiles: Test profile directories
            test_data: Test data for validation
        """
        profile_dir = test_profiles["brave"]["Default"]
    ...
    def test_migrate_profile(self, handler, test_profiles: Dict[str, Dict[str, Path]], temp_dir: Path):
        ...
        """
        source_dir = test_profiles["brave"]["Default"]
        target_dir = temp_dir / "migrated_brave"
