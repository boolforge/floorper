...
def test_browser_detection():
    """Test browser detection functionality with simulated profiles."""
    ...
    for browser_dir in TEST_PROFILES_DIR.iterdir():
        ...
        print(f"  Testing detection of {browser_name}...")
    ...
    # Save results
    with open(TEST_RESULTS_DIR / "detection_results.json", "w") as f:
